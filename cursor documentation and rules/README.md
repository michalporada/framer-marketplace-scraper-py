...
- [x] **Pozycja w kategorii** - zbieranie pozycji szablonu w każdej kategorii (tylko dla templates)
...
### Pozycja w Kategorii (tylko dla szablonów)
Dla każdego szablonu scraper zbiera pozycję w każdej kategorii, w której się znajduje:
- Pozycja liczona od lewej do prawej, od góry do dołu (grid layout)
- Pozycja jest 1-indexed (pierwszy produkt = 1)
- Przykład: `"category_positions": {"Non-profit": 1, "Business": 5, "Modern": 17}`
